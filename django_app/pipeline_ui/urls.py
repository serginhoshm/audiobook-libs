...
urlpatterns = [
    ...
    path("api/videos/<int:video_id>/thumbnail", views.api_video_thumbnail, name="api_video_thumbnail"),
    ...
    path("api/videos/restore", views.api_videos_restore, name="api_videos_restore"),
    path("api/videos/refresh-titles", views.api_titles_refresh, name="api_titles_refresh"),
    path("api/videos/<int:video_id>/metadata", views.api_video_metadata_patch, name="api_video_metadata_patch"),
